...
namespace Ictshop.Areas.Admin.Controllers
{
        ...
        
    {
        ...
        public ActionResult Create([Bind(Include = "Masp,Tensp,Giatien,Soluong,Mota,Sanphammoi,Anhbia,Mahang,MaLoai")] Sanpham sanpham)
        {
        ...
        public ActionResult Edit(int id)
        {
            ...
            var loaiselected = new SelectList(db.LoaiTVs, "MaLoai", "TenLoai",dt.MaLoai);
